function [concentrationMatrix, excRxnNames, timeVec, biomassVec] = dynamicFBALB(model, substrateRxns, initConcentrations, initBiomass, timeStep, nSteps, plotRxns, exclUptakeRxns)
