...
model = addReaction(model, 'EX_caspep_e', 'metaboliteList', {'caspep[e]'},...
'stoichCoeffList', [-1]);
%model = addExchangeRxn(model, {'caspep_e'});
%model.lb(336)=0;%fol uptake
%model.ub(721)=10;model.lb(721)=0.1; %caspep prod
model.lb(362)=0;model.lb(365)=0;model.lb(370)=0;model.lb(376)=0;%model.lb(375)=0;
model.lb(377 )=0;model.lb(379)=0; model.lb(345)=0;model.lb(347)=0;model.lb(351)=0;
model.lb(352)=0;model.lb(355)=0;model.lb(342)=0;model.lb(341)=0;%model.lb(340)=0;
model.lb(332)=0;model.lb(324)=0;model.lb(322)=0;model.lb(320)=0;%model.lb(323)=0; 

%model.ub(362)=0;model.ub(365)=0;model.ub(370)=0;model.ub(376)=0;%model.ub(375)=0;
%model.ub(377)=0;model.ub(379)=0; model.ub(345)=0;model.ub(347)=0;model.ub(351)=0;
%model.ub(352)=0;model.ub(355)=0;model.ub(342)=0;model.ub(341)=0;%model.ub(340)=0;
%323,340,375
%model.lb(731)=0; model.ub(731)=100; %caspep
model.lb(423)=0; %Makes DHORDi lb=0 lac_D = 0.2605
model.ub(515)=0; %Makes POX2 ub=0, we get lac_D result but no succ,acetd
model.lb(731)=0.001;%caspep
model.lb(720)=-0.002; %For cas uptake 3.8
media = getMediaFromModel(model);
nutrients = regexprep(media.reactions,{'EX_','_e'},{'',''});
fba = optimizeCbModel(model);
exportSolutionToJson(model,fba.x,'test5')
...
%exportSolutionToJson(model,fba.x,'test3')
n_rows = 4;
n_cols = 4;
grid0 = zeros(n_rows,n_cols);

%condition: check diffused conc
%if val>0: change lb, concsubstitution
